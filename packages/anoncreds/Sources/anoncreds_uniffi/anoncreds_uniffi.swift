...
public protocol PresentationProtocol : AnyObject {
    ...
    func identifiersJson()  -> String
    
    func proof()  -> Proof
    
    func requestedProofJson()  -> String
...
open func identifiersJson() -> String {
    return try!  FfiConverterString.lift(try! rustCall() {
    uniffi_anoncreds_uniffi_fn_method_presentation_identifiers_json(self.uniffiClonePointer(),$0
    )
})
}
    
open func proof() -> Proof {
    return try!  FfiConverterTypeProof.lift(try! rustCall() {
    uniffi_anoncreds_uniffi_fn_method_presentation_proof(self.uniffiClonePointer(),$0
    )
})
}
    
open func requestedProofJson() -> String {
    return try!  FfiConverterString.lift(try! rustCall() {
    uniffi_anoncreds_uniffi_fn_method_presentation_requested_proof_json(self.uniffiClonePointer(),$0
    )
})
}
...
public struct AggregatedProof {
    public var cHash: String
    public var cListJson: String

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(cHash: String, cListJson: String) {
        self.cHash = cHash
        self.cListJson = cListJson
    }
}



extension AggregatedProof: Equatable, Hashable {
    public static func ==(lhs: AggregatedProof, rhs: AggregatedProof) -> Bool {
        if lhs.cHash != rhs.cHash {
            return false
        }
        if lhs.cListJson != rhs.cListJson {
            return false
        }
        return true
    }
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeAggregatedProof: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> AggregatedProof {
        return
            try AggregatedProof(
                cHash: FfiConverterString.read(from: &buf), 
                cListJson: FfiConverterString.read(from: &buf)
        )
    }

    public static func write(_ value: AggregatedProof, into buf: inout [UInt8]) {
        FfiConverterString.write(value.cHash, into: &buf)
        FfiConverterString.write(value.cListJson, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeAggregatedProof_lift(_ buf: RustBuffer) throws -> AggregatedProof {
    return try FfiConverterTypeAggregatedProof.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeAggregatedProof_lower(_ value: AggregatedProof) -> RustBuffer {
    return FfiConverterTypeAggregatedProof.lower(value)
}
...
public struct Proof {
    ...
    public var aggregatedProof: AggregatedProof
    public var proofsJson: String

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(json: String, aggregatedProof: AggregatedProof, proofsJson: String) {
        self.json = json
        self.aggregatedProof = aggregatedProof
        self.proofsJson = proofsJson
    }
}
...
extension Proof: Equatable, Hashable {
    public static func ==(lhs: Proof, rhs: Proof) -> Bool {
        ...
        if lhs.aggregatedProof != rhs.aggregatedProof {
            return false
        }
        if lhs.proofsJson != rhs.proofsJson {
            return false
        }
        return true
    }
    ...
    public func hash(into hasher: inout Hasher) {
        hasher.combine(json)
        hasher.combine(aggregatedProof)
        hasher.combine(proofsJson)
    }
}
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Proof {
        return
            try Proof(
                ...
                aggregatedProof: FfiConverterTypeAggregatedProof.read(from: &buf), 
                proofsJson: FfiConverterString.read(from: &buf)
        )
    }

    public static func write(_ value: Proof, into buf: inout [UInt8]) {
        FfiConverterString.write(value.json, into: &buf)
        FfiConverterTypeAggregatedProof.write(value.aggregatedProof, into: &buf)
        FfiConverterString.write(value.proofsJson, into: &buf)
    }
}
...
private var initializationResult: InitializationResult = {
    ...
    if (uniffi_anoncreds_uniffi_checksum_method_presentation_identifiers_json() != 9595) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_anoncreds_uniffi_checksum_method_presentation_proof() != 55250) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_anoncreds_uniffi_checksum_method_presentation_requested_proof_json() != 18693) {
        return InitializationResult.apiChecksumMismatch
    }
