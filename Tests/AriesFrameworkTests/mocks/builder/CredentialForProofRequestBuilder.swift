//
//  CredentialForProofRequestBuilder.swift
...
final class CredentialForProofRequestBuilder {
    ...
    private var interval: AnonCredsNonRevokedInterval? = nil
    ...
    @discardableResult
    func setInterval(_ value: AnonCredsNonRevokedInterval?) -> Self {
        self.interval = value
        return self
    }

    func build() -> CredentialForProofRequest {
        let credentialInfo = AnonCredsCredentialInfoBuilder()
            .setCredentialId(credentialId)
            .setAttributes(attributes)
            .setSchemaId(schemaId)
            .setCredentialDefinitionId(credentialDefinitionId)
            .setRevocationRegistryId(revocationRegistryId)
            .setCredentialRevocationId(credentialRevocationId)
            .setMethodName(methodName)
            .setCreatedAt(createdAt)
            .setUpdatedAt(updatedAt)
            .setLinkSecretId(linkSecretId)
            .build()

        return CredentialForProofRequest(
