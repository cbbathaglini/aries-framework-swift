...
//        let credentialRecord = try await aliceAgent.credentialExchangeRepository.findByThreadAndConnectionId(
...
//        let faberCredentialRecord = try await faberAgent.credentialExchangeRepository.findByThreadAndConnectionId(
