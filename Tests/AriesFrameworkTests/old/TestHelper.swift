...
//        guard let genesisUrl = Bundle.module.url(forResource: "local-genesis", withExtension: "txn") else {
//            throw AriesFrameworkError.frameworkError("Cannot find local-genesis.txn")
//        }
//        let config = AgentConfig(walletId: "AFSTestWallet_\(name)",
//            walletKey: key,
//            genesisPath: genesisUrl.path,
...
//        guard let genesisUrl = Bundle.module.url(forResource: "bcovrin-genesis", withExtension: "txn") else {
...
//        config.genesisPath = genesisUrl.path
